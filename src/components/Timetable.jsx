...
export default function Timetable({ timetable = [], selectedClassId, isAdminLoggedIn, onSaveTimetable }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950/50 to-slate-900 border border-slate-800 p-6 rounded-2xl shadow-xl flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1 flex items-center gap-2">
            <Clock className="w-3.5 h-3.5 text-indigo-400" /> Daily Academy Timing: <strong className="text-white">3:00 PM - 6:30 PM</strong>
          </p>
        </div>
              ...
              {isEditing ? (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl text-xs font-semibold flex items-center gap-1"
                  >
                  ...
                  <button
                    ...
                    className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold flex items-center gap-2 shadow-lg shadow-emerald-600/30 transition-colors"
                  >
